...
// --- DEBUGGING (Cek apakah fungsi terbaca) ---
...
// 2. Ambil Semua Laporan (List Barang)
...
// 4. Manajemen Laporan (Pending, Approved, Archived)
// Menggunakan satu endpoint fleksibel dengan query ?status=...
router.get('/admin/reports', adminController.getReportsByStatus);

// 5. Update Status Laporan (Approve / Reject / Resolve)
